...
class HunyuanVideoPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        #print(len(semantic_images))
        #print(semantic_images[0],semantic_images[0].shape,"hhhhhhhhhhhhhhhhhhhhhhhhhhhhhh")
        print(self.text_encoder.use_template,data_type,self.clip_skip,"nnnnnnnnnnnnnnnnnnnnnnnnnnn")
        (
            prompt_embeds,
            negative_prompt_embeds,
            prompt_mask,
