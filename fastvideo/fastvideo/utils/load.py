...
from wan.modules.model import WanModel as WanModel_yume
from wan.modules.model import WanModel as wanori_yume
#from wanori.modules.model import WanModel as WanModel_ori
#from wanori.modules.model import WanAttentionBlock as WanAttentionBlock_ori
from wan23.modules.model import WanModel as WanModel1
from wan23.modules.model import WanAttentionBlock as WanAttentionBlock1
#from wan22.modules.model import(WanModel, WanAttentionBlock)
...
def get_no_split_modules(transformer):
    ...
    elif isinstance(transformer, WanModel1):
        return (WanAttentionBlock1, )
    elif isinstance(transformer, WanModel_yume):
        return (WanAttentionBlock_yume, )
    else:
