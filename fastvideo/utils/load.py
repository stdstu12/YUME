...
from wan23.modules.model import WanModel as WanModel_new
from wan23.modules.model import WanAttentionBlock as WanAttentionBlock_new
...
def get_no_split_modules(transformer):
    ...
    elif isinstance(transformer, WanModel_new):
        return (WanAttentionBlock_new, )
    else:
